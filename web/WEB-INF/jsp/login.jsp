    ...
    <div id="auth">
        ...
        <form method="post" action="<c:url value="/login" />">
            ...
            <div class="form-group">
                <div class="controls">
                    <input type="text" class="form-control" id="auth_key" name="userName" value="wangz"
        ...
        <hr>
        <p class="text-center misc-links">忘记密码&nbsp;&bull;&nbsp; <a href="http://localhost:8080/register"
                                                                    target="_blank"
                                                                    class="text-center misc-links">注册</a></p>
    </div>
</div>
</body>
